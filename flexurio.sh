...
if [ "$1" == "version" ]; then
 ...
 # ================ SERVER MODULE =================
   ...
   git clone https://github.com/VNEU/FLEXURIO-CORE.git
 ...
 # ================ MOBILE MODULE =================
   ...
   echo " Flexurio is tools to bootstraping node on server - desktop, also with react-native on mobile app. Please read this options carefully. Any question feel free to email us at yulius.jayuda@gmail.com or text at +628119003077. Please visit flexurio.com to join our community"
